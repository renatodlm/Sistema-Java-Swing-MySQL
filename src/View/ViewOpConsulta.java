 ...
 */
public final class ViewOpConsulta extends javax.swing.JFrame {
    ...
    private void btAlterar1ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btAlterar1ActionPerformed
        ...
        try {
            ...
            new ViewOpVisualizar(modelOp).setVisible(true);
        } catch (Exception e) {
    ...
    public void carregarProcessosDeConsultar() {
        listaModelOp = controllerOp.FiltraOpDecrescenteConsultasController();
        DefaultTableModel modelo = (DefaultTableModel) tbProcessosAndamento.getModel();
        modelo.setNumRows(0);
        //CARREGA OS DADOS DA LISTA NA TABELA
    ...
    public static ViewOpConsulta opConsulta;
