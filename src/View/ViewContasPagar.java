...
public class ViewContasPagar extends javax.swing.JFrame {
    ...
    public ViewContasPagar() {
        ...
        jTabbedPanelContasAPagar.setSelectedIndex(0);
    ...
    private void panelTabbedKGVerficiar() {
        if (jTabbedPanelContasAPagar.getSelectedIndex() == 0) {
            KBContasPagar.setSelected(true);
        } else {
            KBContasPagar.setSelected(false);
        }
        if (jTabbedPanelContasAPagar.getSelectedIndex() == 1) {
            kBContasPagas.setSelected(true);
        } else {
            kBContasPagas.setSelected(false);
        }
        if (jTabbedPanelContasAPagar.getSelectedIndex() == 2) {
    ...
    private void initComponents() {
        ...
        KBContasPagar = new keeptoo.KButton();
        kBContasPagas = new keeptoo.KButton();
        kBRegistrarContas = new keeptoo.KButton();
        kButtonPendentes1 = new keeptoo.KButton();
        jTabbedPanelContasAPagar = new javax.swing.JTabbedPane();
        ContasAPagar = new javax.swing.JPanel();
        ...
        ContasPagas = new javax.swing.JPanel();
        ...
        KBContasPagar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/18x18/Fall.png"))); // NOI18N
        KBContasPagar.setText("CONTAS A PAGAR");
        KBContasPagar.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        KBContasPagar.setHorizontalAlignment(javax.swing.SwingConstants.LEADING);
        KBContasPagar.setHorizontalTextPosition(javax.swing.SwingConstants.LEADING);
        KBContasPagar.setIconTextGap(10);
        KBContasPagar.setkBackGroundColor(new java.awt.Color(255, 255, 255));
        KBContasPagar.setkBorderRadius(0);
        KBContasPagar.setkEndColor(new java.awt.Color(197, 201, 206));
        KBContasPagar.setkForeGround(new java.awt.Color(102, 102, 102));
        KBContasPagar.setkHoverEndColor(new java.awt.Color(234, 239, 243));
        KBContasPagar.setkHoverForeGround(new java.awt.Color(102, 102, 102));
        KBContasPagar.setkHoverStartColor(new java.awt.Color(234, 239, 243));
        KBContasPagar.setkPressedColor(new java.awt.Color(153, 153, 153));
        KBContasPagar.setkSelectedColor(new java.awt.Color(255, 255, 255));
        KBContasPagar.setkStartColor(new java.awt.Color(197, 201, 206));
        KBContasPagar.setPreferredSize(new java.awt.Dimension(210, 45));
        KBContasPagar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KBContasPagarActionPerformed(evt);
            }
        });

        kBContasPagas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/18x18/Down.png"))); // NOI18N
        kBContasPagas.setText("CONTAS PAGAS");
        ...
        kGradientPanel14Layout.setHorizontalGroup(
            ...
            .add(kGradientPanel14Layout.createSequentialGroup()
                .add(10, 10, 10)
                .add(KBContasPagar, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(10, 10, 10)
            ...
            .add(kGradientPanel14Layout.createSequentialGroup()
                ...
                .add(kGradientPanel14Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, kGradientPanel14Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                        ...
                        .add(KBContasPagar, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 40, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
        ...
        jTabbedPanelContasAPagar.setBackground(new java.awt.Color(255, 255, 255));
        jTabbedPanelContasAPagar.setMaximumSize(new java.awt.Dimension(1080, 720));
        jTabbedPanelContasAPagar.setMinimumSize(new java.awt.Dimension(1080, 720));
        jTabbedPanelContasAPagar.setPreferredSize(new java.awt.Dimension(1080, 720));

        ContasAPagar.setBackground(new java.awt.Color(255, 255, 255));
        ContasAPagar.setPreferredSize(new java.awt.Dimension(1080, 1080));
        ...
        ContasAPagar.add(kGradientPanel6);

        kGradientPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1), "PAGAMENTO PENDENTE", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(51, 51, 51))); // NOI18N
        ...
        tbContasPagar.setBackground(new java.awt.Color(247, 247, 247));
        tbContasPagar.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        ...
        tbContasPagar.setGridColor(new java.awt.Color(247, 247, 247));
        tbContasPagar.setMinimumSize(new java.awt.Dimension(610, 0));
        tbContasPagar.setRowHeight(20);
        tbContasPagar.setSelectionBackground(new java.awt.Color(0, 153, 0));
        tbContasPagar.getTableHeader().setReorderingAllowed(false);
        jScrollPane7.setViewportView(tbContasPagar);
        if (tbContasPagar.getColumnModel().getColumnCount() > 0) {
            tbContasPagar.getColumnModel().getColumn(0).setMinWidth(50);
            tbContasPagar.getColumnModel().getColumn(0).setPreferredWidth(50);
            ...
            tbContasPagar.getColumnModel().getColumn(3).setMinWidth(120);
            tbContasPagar.getColumnModel().getColumn(3).setPreferredWidth(120);
            tbContasPagar.getColumnModel().getColumn(3).setMaxWidth(120);
            tbContasPagar.getColumnModel().getColumn(4).setMinWidth(120);
            tbContasPagar.getColumnModel().getColumn(4).setPreferredWidth(120);
            tbContasPagar.getColumnModel().getColumn(4).setMaxWidth(120);
            tbContasPagar.getColumnModel().getColumn(6).setMinWidth(120);
            tbContasPagar.getColumnModel().getColumn(6).setPreferredWidth(120);
            tbContasPagar.getColumnModel().getColumn(6).setMaxWidth(120);
        }

        kGradientPanel7.add(jScrollPane7, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, 1020, 380));

        ContasAPagar.add(kGradientPanel7);
        ...
        jbPagarConta.setPreferredSize(new java.awt.Dimension(200, 35));
        jbPagarConta.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbPagarContaActionPerformed(evt);
            }
        });
        kGradientPanel5.add(jbPagarConta, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 20, -1, -1));
        ...
        jbExcluirPagar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/18x18/No-entry.png"))); // NOI18N
        ...
        kGradientPanel5.add(jbExcluirPagar, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 20, -1, -1));

        ContasAPagar.add(kGradientPanel5);

        jTabbedPanelContasAPagar.addTab("CONTAS A PAGAR", ContasAPagar);

        ContasPagas.setBackground(new java.awt.Color(255, 255, 255));
        ...
        kGradientPanel10.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 30, 100, -1));
        ...
        btClear.setPreferredSize(new java.awt.Dimension(70, 40));
        ...
        ContasPagas.add(kGradientPanel10);

        kGradientPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1), "CONTAS PAGAMENTO EFETUADO", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(51, 51, 51))); // NOI18N
        ...
        tbContasPagas.setBackground(new java.awt.Color(247, 247, 247));
        tbContasPagas.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        ...
        tbContasPagas.setGridColor(new java.awt.Color(247, 247, 247));
        tbContasPagas.setMinimumSize(new java.awt.Dimension(610, 0));
        tbContasPagas.setRowHeight(20);
        tbContasPagas.setSelectionBackground(new java.awt.Color(0, 153, 0));
        tbContasPagas.getTableHeader().setReorderingAllowed(false);
        jScrollPane8.setViewportView(tbContasPagas);
        if (tbContasPagas.getColumnModel().getColumnCount() > 0) {
            tbContasPagas.getColumnModel().getColumn(0).setMinWidth(50);
            tbContasPagas.getColumnModel().getColumn(0).setPreferredWidth(50);
            ...
            tbContasPagas.getColumnModel().getColumn(3).setMinWidth(120);
            tbContasPagas.getColumnModel().getColumn(3).setPreferredWidth(120);
            tbContasPagas.getColumnModel().getColumn(3).setMaxWidth(120);
            tbContasPagas.getColumnModel().getColumn(5).setMinWidth(120);
            tbContasPagas.getColumnModel().getColumn(5).setPreferredWidth(120);
            tbContasPagas.getColumnModel().getColumn(5).setMaxWidth(120);
            tbContasPagas.getColumnModel().getColumn(6).setMinWidth(120);
            tbContasPagas.getColumnModel().getColumn(6).setPreferredWidth(120);
            tbContasPagas.getColumnModel().getColumn(6).setMaxWidth(120);
        }

        kGradientPanel8.add(jScrollPane8, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, 1020, 380));

        ContasPagas.add(kGradientPanel8);
        ...
        ContasPagas.add(kGradientPanel9);

        jTabbedPanelContasAPagar.addTab("CONTAS PAGAS", ContasPagas);
        ...
        kGDetalhesDaConta.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 100, -1, -1));
        ...
        kGFuncionarioAgente.add(cbFuncionario, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 50, 700, 28));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel2.setText("Banco do Depósito");
        kGFuncionarioAgente.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 30, -1, -1));

        cbBancos.setEnabled(false);
        kGFuncionarioAgente.add(cbBancos, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 50, 260, 28));
        ...
        jTabbedPanelContasAPagar.addTab("REGISTRAR CONTA", RegistrarContas);

        getContentPane().add(jTabbedPanelContasAPagar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 18, -1, 720));
    ...
    private void btAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAlterarActionPerformed
        try {
            ...
            //avançar para aba 3
            jTabbedPanelContasAPagar.setSelectedIndex(jTabbedPanelContasAPagar.getSelectedIndex() + 2);
            panelTabbedKGVerficiar();
        } catch (Exception e) {
    ...
    private void jbPagarContaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbPagarContaActionPerformed
        ...
        try {
            ...
            String Verifica = (String) tbContasPagar.getValueAt(linha, 5);
            if ("  /  /    ".equals(Verifica) || "null".equals(Verifica) || Verifica == null) {
                modelContaPagar.setPagamento(String.valueOf(bl.converterDataParaDateUS(new java.util.Date(System.currentTimeMillis()))));
            } else {
                modelContaPagar.setPagamento(new Mascaras().DataSalvanosql(Verifica));
            }
            //pegunta
            ...
            jTabbedPanelContasAPagar.setSelectedIndex(jTabbedPanelContasAPagar.getSelectedIndex() + 1);
            panelTabbedKGVerficiar();
        } catch (Exception e) {
    ...
    private void cbFuncionariosEfetuadoPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_cbFuncionariosEfetuadoPopupMenuWillBecomeInvisible
        ...
        if (this.cbFuncionariosEfetuado.isPopupVisible() && this.cbFuncionariosEfetuado.getSelectedItem() != null) {
            ...
            DefaultTableModel tabela = (DefaultTableModel) this.tbContasPagar.getModel();
            this.tbContasPagar.setRowSorter(null);
            carregarContasPagas();
        }
    ...
    private void btClearEfetuadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btClearEfetuadoActionPerformed
        ...
        this.tbContasPagas.setRowSorter(null);
        listarFuncionarios();
        cbFuncionariosEfetuado.setSelectedIndex(-1);
    ...
    private void jbVisualizarContaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbVisualizarContaActionPerformed
        ...
        if (tbContasPagas.getRowCount() > 0) {
    ...
    private void KBContasPagarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KBContasPagarActionPerformed
        // TODO add your handling code here:
        jTabbedPanelContasAPagar.setSelectedIndex(0);
        panelTabbedKGVerficiar();
    }//GEN-LAST:event_KBContasPagarActionPerformed

    private void kBContasPagasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kBContasPagasActionPerformed
        // TODO add your handling code here:
        jTabbedPanelContasAPagar.setSelectedIndex(1);
        panelTabbedKGVerficiar();
    ...
    private void kBRegistrarContasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kBRegistrarContasActionPerformed
        ...
        if (jtfCodigoConta.isEnabled()) {
            jTabbedPanelContasAPagar.setSelectedIndex(2);
            panelTabbedKGVerficiar();
        } else {
    ...
    private void tfProcessoNumeroFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfProcessoNumeroFocusLost
        ...
        try {
            ...
            this.cbSeguradorasProcesso.setSelectedItem(controllerSeguradora.getSeguradoraController(modelOp.getSeguradoras()).getNome());
            this.jcbProcessos.setSelectedItem(modelOp.getCodigo());
            this.cbAgentePtgoPorKMSeguradoraProcessos.setSelectedItem(new Moeda().valorStringTODoubleAtt(String.valueOf(controllerSeguradora.getSeguradoraController(modelOp.getSeguradoras()).getSeg_km())));
            this.cbSinistroProcesso.setSelectedItem(String.valueOf(modelOp.getNumeroSinistro()));
            this.cbDataProcesso.setSelectedItem(String.valueOf(modelOp.getDataEntrada()));
            this.jLnomeSegProcesso.setText(this.cbSeguradorasProcesso.getSelectedObject().toString());
    ...
    private boolean recuperarConta(int pCodigoConta) {
        ...
        this.jCheckRepasse.setSelected(modelContaPagar.getRepasse());
        this.jChecKFuncionario.setSelected(modelContaPagar.isFuncionarioCheck());
        if (jChecKFuncionario.isSelected()) {
            this.cbFuncionario.setSelectedItem(controllerFuncionario.getFuncionarioController(modelContaPagar.getCodigoPessoa()).getNome());
            this.cbCodFuncionario.setSelectedItem(controllerFuncionario.getFuncionarioController(modelContaPagar.getCodigoPessoa()).getCodigo());
            this.cbBancos.setSelectedItem(controllerBancos.getBancosControllerCod(modelContaPagar.getBanco()).getBanco_nome());
        } else {
            this.cbFuncionario.setSelectedIndex(-1);
            this.cbCodFuncionario.setSelectedIndex(-1);
            this.cbBancos.setSelectedIndex(-1);
        }
        this.jcbTipoConta.setSelectedItem(modelContaPagar.getTipoPagamento());
        ...
        this.jdData.setText(new Mascaras().DataRecuperasql(String.valueOf(modelContaPagar.getData())));
        this.jdPagamento.setText(new Mascaras().DataRecuperasql(String.valueOf(modelContaPagar.getPagamento())));
        this.jdVencimento.setText(new Mascaras().DataRecuperasql(String.valueOf(modelContaPagar.getVencimento())));
        this.jFValor.setText(new Moeda().valorStringTODoubleAtt(String.valueOf(modelContaPagar.getValor())));

        //VERIFICA SE EXISTE REPASSE
        if (jCheckRepasse.isSelected()) {
            this.jcbProcessos.setSelectedItem(controllerOp.getOpController(modelContaPagar.getProcessos()).getCodigo());
            this.tfProcessoNumero.setText(String.valueOf(modelContaPagar.getProcessos()));
            //dados
            modelOp = controllerOp.getOpController(Integer.parseInt(tfProcessoNumero.getText()));
            this.cbSeguradorasProcesso.setSelectedItem(controllerSeguradora.getSeguradoraController(modelOp.getSeguradoras()).getNome());
            this.cbAgentePtgoPorKMSeguradoraProcessos.setSelectedItem(new Moeda().valorStringTODoubleAtt(String.valueOf(controllerSeguradora.getSeguradoraController(modelOp.getSeguradoras()).getSeg_km())));
    ...
    private boolean salvar() throws Exception {
        ...
        modelContaPagar.setFuncionarioCheck(jChecKFuncionario.isSelected());

        if (jChecKFuncionario.isSelected()) {
            modelContaPagar.setCodigoPessoa(controllerFuncionario.getFuncionarioController(this.cbFuncionario.getSelectedItem().toString()).getCodigo());
            modelContaPagar.setBanco(controllerBancos.getBancosControllerNome(cbBancos.getSelectedItem().toString()).getCodigo());
        } else {
            modelContaPagar.setCodigoPessoa(0);
            modelContaPagar.setBanco(0);
        }
        modelContaPagar.setTipoPagamento(this.jcbTipoConta.getSelectedItem().toString());
        modelContaPagar.setDescricao(this.jtfDescricao.getText());
        modelContaPagar.setData(new Mascaras().DataSalvanosql(String.valueOf(jdData.getText())));
        modelContaPagar.setVencimento(new Mascaras().DataSalvanosql(String.valueOf(jdVencimento.getText())));
        modelContaPagar.setPagamento(new Mascaras().DataSalvanosql(String.valueOf(jdPagamento.getText())));
        if (jCheckRepasse.isSelected()) {
            modelContaPagar.setProcessos(Integer.parseInt(tfProcessoNumero.getText()));
        }
        modelContaPagar.setSituacao(0);
        modelContaPagar.setValor(Double.parseDouble((new Moeda().FommatoStringoSomarMil(this.jFValor.getText()))));
        modelContaPagar.setObservacao(this.jtfObservacao.getText());
        modelContaPagar.setRepasse(jCheckRepasse.isSelected());
    ...
    private void carregarContasPagar() {
        listaModelContaPagar = controllerContaPagar.getListaContaPagarController(0);
        ...
        for (int i = 0; i < cont; i++) {
            nomeFuncionario = controllerFuncionario.getFuncionarioController(listaModelContaPagar.get(i).getCodigoPessoa()).getNome();
            if ("".equals(nomeFuncionario) || nomeFuncionario == null) {
                nomeFuncionario = "Nenhum Funcionário";
            }
            modelo.addRow(new Object[]{
                listaModelContaPagar.get(i).getCodigo(),
                listaModelContaPagar.get(i).getDescricao(),
                nomeFuncionario,
                ...
                (new Mascaras().DataRecuperasql(String.valueOf(listaModelContaPagar.get(i).getPagamento()))),
                (new Moeda().valorStringTODoubleAtt(String.valueOf(listaModelContaPagar.get(i).getValor())))});
        }
    }

    private void carregarContasPagas() {
        listaModelContaPagar = controllerContaPagar.getListaContaPagarController(1);
    ...
    private void habilitaDesabilitarCampos(boolean operacao) {
        ...
        jLabel9.setEnabled(operacao);
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JPanel ContasAPagar;
    private javax.swing.JPanel ContasPagas;
    private javax.swing.JButton JbSAlvar;
    private keeptoo.KButton KBContasPagar;
    ...
    private javax.swing.JTabbedPane jTabbedPanelContasAPagar;
    ...
    private void carregarContasPagasBusca() {
        Datas bl = new Datas();
    ...
    public static ViewContasPagar contasPagar;
