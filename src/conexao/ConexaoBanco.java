...
public class ConexaoBanco {
    ...
    private String servidor = "localhost";
     private String nomeDoBanco = "sistema";
     private String usuario = "root";
     private String senha = "";
    /*private String servidor = "192.168.15.201:3306";
    private String nomeDoBanco = "db_controle";
    private String usuario = "controle";
    private String senha = "controle@004";*/

    public ConexaoBanco() {

    }

    public ConexaoBanco(String pServidor, String pNomeDoBanco, String pUsuario, String pSenha) {
     ...
     *
     * @param pSQL Consulta SQL
     * @return int Consulta SQL por Resultado
     */
     ...
     * Executa insert SQL
     *
     * @param pSQL Executa Insert no SQL
     * @return boolean Retorna Status da execução
     */
    public int insertSQL(String pSQL) {
        ...
        try {
            ...
            while (this.resultSet.next()) {
                BDstatus = this.resultSet.getInt(1);
            }
